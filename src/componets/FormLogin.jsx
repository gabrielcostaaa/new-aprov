                    ...
                    <div className='mt-5 flex justify-between items-center'>
                        <div>
                            <label className='inline-flex items-center cursor-pointer'>
                                ...
                                />
                                <div className='relative w-11 h-6 bg-gray peer-focus:outline-none rounded-full peer dark:bg-white peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[""] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-white after:border after:rounded-full after:w-5 after:h-5 after:transition-all dark:border-gray-600 peer-checked:bg-aprov'></div>
